...
\footnotetext{Chromebook -- laptop z systemem ChromeOS, który używa przeglądarki Google Chrome jako głównego interfejsu użytkownika}
...
\begin{figure}[H]
    \centering
    \vspace*{15pt}
    \includegraphics[width=0.717\textwidth]{images/collaboration.pdf} % 0.72809
